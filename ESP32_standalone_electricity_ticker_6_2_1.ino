/*
  ESP32_standalone_electricity_ticker_6_2_1.ino
  -----------------------------------------------------
  ...
  - This correctly returns the current interval we're in, not the next one
...
*/
 ...
 // ========================================================================
 // Dynamic Electricity Ticker for XIAO ESP32C3 - VERSION 6.2.1
...
void displaySecondaryList() {
    ...
    snprintf(lines[18], sizeof(lines[18]), "price ticker v6.2.1");
...
void setup() {
    Serial.begin(115200);
    debugPrint(2, "Starting Dynamic Electricity Ticker v6.2.1 (15-MINUTE DETAIL MODE) - DST-SAFE");

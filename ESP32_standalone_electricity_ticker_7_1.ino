/*
  ESP32_standalone_electricity_ticker_7_1.ino
  -----------------------------------------------------
...
void displaySecondaryList() {
    ...
    snprintf(lines[18], sizeof(lines[18]), "price ticker v7.1  ");
...
void setup() {
    Serial.begin(115200);
    debugPrint(2, "Starting Dynamic Electricity Ticker v7.1 (Neg Price Fee) - DST-SAFE");
